...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='C:\\Users\\Tai\\Desktop\\DAT_K22\\dataset\\drone\\multispectral-object-detection-main\models\\transformer\mymodel.yaml', help='model.yaml')
